...
AddSubClass("bard","college of spirits",{
	...
	features : {
		"subclassfeature3" : {
			...
			minlevel : 3,
			description : desc([
				"I learn the Guidance cantrip, not counting for the number I can know, and can cast it at a range of 60 ft.",
			]),
			spellcastingBonus : {
		...
		"subclassfeature3.1" : {
			...
			minlevel : 3,
			description : desc([
				"I can use a candle, a crystal ball, a talking board, a tarokka deck, or a skull as a spellcasting focus.",
			]),
		},
		"subclassfeature3.2" : {
        ...
        "subclassfeature6.1" : {
			...
			minlevel : 6,
			description : desc([
				"When I cast a bard spell that deals damage or restores HP through my Spiritual Focus, I can add 1d6 to the damage or healing.",
			])
        },
		"subclassfeature14" : {
